...
<OAOperation operationId="get-usd-uyu" :hide-default-footer="false">
...
<!--@include: ./parts/get-usd-uyu-description-after.md -->
...
```bash [cURL] 
curl -X GET https://uy.dolarapi.com/v1/cotizaciones/usd
```
...
```php-vue [PHP]
file_get_contents("https://uy.dolarapi.com/v1/cotizaciones/usd")
```
